...
#current pick only has a problem where it touches it but doesn't grasp it properly falls out
#   if it grips well succeeds
#   also only works if i make it easier ie. make cube at (0.65) Instead of (0.5)